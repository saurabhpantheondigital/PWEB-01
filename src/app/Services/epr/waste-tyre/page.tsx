...
export default function WasteTyrePage() {
  ...
  return (
    <main className="min-h-screen bg-[#F0F2F1] pt-32 pb-0 overflow-hidden selection:bg-emerald-200/40 selection:text-slate-900 relative">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-[15%] -right-20 w-[800px] h-[800px] opacity-[0.15] grayscale pointer-events-none z-0 rotate-[12deg]">
          <img 
            src="/EPR/tyre_waste_illustration.png" 
            alt="Waste Tyre Illustration" 
      ...
      <div className={`${shell} relative z-10`}>
        ...
        <div className="max-w-6xl mx-auto text-center relative min-h-[calc(100vh-320px)] flex flex-col justify-center items-center mb-16 md:mb-[-10px]" >
          ...
          >
            ...
            <span className="text-[10px] md:text-[12px] font-black uppercase tracking-[0.15em] text-emerald-600 font-clash">India&apos;s #1 Waste Tyre EPR Platform</span>
          </motion.div>
          ...
          >
            Waste Tyre <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 via-emerald-500 to-emerald-400">Compliance.</span>
          </motion.h1>
          ...
          >
            Meet your 100% ELT collection target — manage retreaders, <br className="hidden md:block" />
            <span className="text-slate-900 font-bold">recyclers, and CPCB certificates</span> without manual tracking.
          </motion.p>
        ...
        <section className="mb-24 md:mb-32 relative overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-20 items-start relative z-10">
            ...
            >
              <h2 className="text-3xl md:text-5xl font-black tracking-tight text-slate-900 font-clash">What Is Waste Tyre EPR in India?</h2>
            ...
            <div className="relative pt-0 md:pt-20">
              ...
              >
                ...
                <div className="space-y-4 md:space-y-6">
                  {[
                    { title: "Tyre Manufacturers", desc: "Entities manufacturing and selling new tyres — passenger car, truck, two-wheeler, OTR, and agri tyres" },
                    { title: "Brand Owners", desc: "Companies selling tyres under their own label, even if manufactured by a third party" },
                    { title: "Importers", desc: "Entities importing new tyres for sale, or importing vehicles fitted with new tyres" },
                    { title: "Automobile Makers", desc: "Vehicle makers importing tyres fitted to new vehicles sold domestically" },
                    { title: "Waste Tyre Importers", desc: "Entities importing waste tyres for processing or retreading" },
                    { title: "Retreaders & Recyclers", desc: "CPCB-registered processors that generate EPR certificates for Producers" }
                  ].map((item, i) => (
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-8 md:gap-y-12 gap-x-8 md:gap-x-12">
                {[
                  { label: "Governing Rules", desc: "Hazardous and Other Wastes Amendment Rules, 2022 — Schedule IX. Regulated by CPCB." },
                  { label: "CPCB Portal", desc: "eprtyres.cpcb.gov.in — registration, EPR obligation submission, and certificate transfer." },
                  { label: "Collection Target", desc: "100% End-of-Life Tyre (ELT) collection — based on tyre weight put in market 2 years prior." },
                  { label: "Certificate Types", desc: "Recycling Certificates (pyrolysis, crumb rubber) & Retreading Certificates." },
                  { label: "Denominations", desc: "0.1T to 1,000T — valid for 2 years from the end of the financial year of generation." },
                  { label: "Credit Price", desc: "Tyre EPR credits (TYR-PY) trading at approximately ₹12 per kg on CPCB ETP." },
                  { label: "Return Deadline", desc: "Annual return filed on CPCB tyre portal by 15 August (recently extended)." },
                  { label: "Penalties", desc: "₹10 lakh to ₹50 lakh per violation · Public defaulter listing · Registration suspension." },
                  { label: "2-Year Lag", desc: "Obligation is calculated based on production data from two years ago to account for life cycle." }
                ].map((item, i) => (
        ...
        <ContextualCTA 
          title="Is your 100% ELT target strategy ready?"
          desc="The new collection mandates are in effect. Don't wait until the August 15 deadline to procure your retreading and recycling certificates."
        ...
        <section className="mb-24 md:mb-32">
          <div className="flex flex-col items-center text-center mb-12 md:mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-black tracking-tighter text-slate-900 max-w-3xl font-clash px-4">Why Companies Struggle with Tyre EPR</h2>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {[
              { title: "2-Year Lag Calculation", desc: "Calculating target weight requires knowing exactly how many tyres (by weight) you sold 2 years ago, per category." },
              { title: "Retreader Complexity", desc: "EPR obligation can be partially met through retreading certificates — requiring a mixed procurement strategy." },
              { title: "Recycler Verification", desc: "CPCB verification for tyre recyclers is slow — many listed recyclers have expired authorisations." },
              { title: "Denomination Matching", desc: "Certificates range from 0.1T to 1,000T — matching them to exact obligation quantities requires precise management." },
              { title: "Informal Sector Risk", desc: "Ensuring certificates come only from CPCB-registered retreaders, not informal operators, requires constant checking." },
              { title: "Return Filing Burden", desc: "Annual return requires compiling certificate IDs, registration numbers, and GST invoices across the year." }
            ].map((item, i) => (
              <motion.div 
                key={i}
                initial={{ opacity: 0, y: 20 }}
          ...
          <div className="bg-white rounded-[2.5rem] md:rounded-[4rem] p-8 md:p-16 text-slate-900 overflow-hidden relative shadow-[0_40px_100px_-20px_rgba(0,0,0,0.04)] border border-slate-100">
            ...
            <div className="relative z-10">
              <div className="max-w-2xl mb-12 md:mb-16">
                ...
                <h2 className="text-2xl md:text-5xl font-black tracking-tighter mb-4 leading-tight text-slate-900 font-clash">How EcoTrace Solves Waste Tyre EPR</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-10 md:gap-y-12">
                {[
                  { title: "2-Year Lag Calculator", desc: "Automatically calculates current year ELT targets based on sales data from 2 years prior — per tyre category." },
                  { title: "Mixed Certificate Manager", desc: "Manage both retreaders and recyclers separately. Mix certificate types to optimise your cost per tonne." },
                  { title: "Obligation Dashboard", desc: "Real-time view of total ELT obligation vs certificates procured — split between recycling and retreading." },
                  { title: "Denomination Manager", desc: "Match certificate denominations (0.1T to 1,000T) to your exact obligation — preventing over-purchase." },
                  { title: "Recycler Validity Check", desc: "Cross-validates every processor against CPCB's list — flagging expired authorisations before purchase." },
                  { title: "Annual Return Generator", desc: "Complete CPCB tyre portal annual return — category data, certificate ledger, and EC calculation in one click." },
                  { title: "ETP Price Alerts", desc: "Monitors tyre certificate prices on CPCB ETP and alerts when shortfall creates financial risk." },
                  { title: "Sales Data Integration", desc: "Pulls volume data from records — auto-applies weight matrix per tyre type for precise target calculation." }
                ].map((item, i) => (
      ...
      <EPRCTA 
        title="Ready to automate your Waste Tyre EPR?"
        description="Join leading tyre manufacturers and importers. Automate ELT targets, retreader records, and CPCB returns on EcoTrace."
      />
    </main>
  );
}
